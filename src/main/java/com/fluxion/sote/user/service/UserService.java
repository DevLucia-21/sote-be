...
public interface UserService {
    ...
    /**
     * 닉네임, 생년월일, 보안 질문/답변이 일치하는 회원의 이메일을 조회합니다.
     *
     * @param req 닉네임, 생년월일, 질문/답변을 담은 DTO
    ...
    /**
     * 사용자 이메일, 질문ID, 답변을 받아 보안 질문 일치 여부를 확인합니다.
     *
     * @param email 사용자 이메일
     * @param questionId 질문 ID
     * @param answer 보안 질문 답변
     * @return 일치하면 true, 아니면 false
     */
    boolean checkSecurity(String email, Integer questionId, String answer);
